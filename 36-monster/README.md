...
- *When the page loads, show the first 10 monsters. Each monster's name, age, and
  ...
  **When the page loads, make a GET fetch request to localhost:3000/monsters/?_limit=10 and render the monsters to the DOM**
...
- Above your list of monsters, you should have a form to create a new monster.
  ...
  **When a user clicks the submit button, make a POST fetch call to localhost:3000/monsters and add a new monster to the DOM**
...
- At the end of the list of monsters, show a button. 
  ...
  **When the `next` button is clicked make a GET request to "http://localhost:3000/monsters/?_limit=10&_page=(current_page+1)" and render the new monsters**
