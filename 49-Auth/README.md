...
- have a user "log in" without actually using their password!!!!

##Problems
- Back end has no password AND DO NOT store password as plain text
  - store the passwords as password_digest
  - <user>.authenticate(password) => false/user instance
- Front end need to have log in persistance
